...
try{
    ...
    emailjs.send('service_du5gah9','template_p8wjedz', data1, 'rnZTQ-brOm6WrlDU4')
...
try{
    ...
    emailjs.send('service_du5gah9','template_p8wjedz', data2, 'rnZTQ-brOm6WrlDU4')
...
try{
    ...
    emailjs.send('service_du5gah9','template_p8wjedz', data3, 'rnZTQ-brOm6WrlDU4')
